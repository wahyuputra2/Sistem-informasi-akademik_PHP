...
$students = query("SELECT * FROM siswa WHERE kd_kelas = '$kls'");
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($students as $student) : ?>
                                        <tr>
                                            <td><?= $i ?> </td>
                                            <td><?= $student["nisn"]; ?></td>
                                            <td><a href="profil_siswa.php?nama=<?= $student["nisn"]; ?>" class="text-secondary"><?= $student["nama_siswa"]; ?> </a></td>
                                            <td width="10px">
                                                <?php
                                                if ($lvl == 'admin') :
                                                ?>
                                                    <a class="btn btn-danger" href="hapus_siswa.php?nisn=<?= $student["nisn"]; ?>" role="button">
                                                        Hapus</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                            ...
                            if ($lvl == 'admin') :
                            ?>
                                <center><a href="laporan_siswa.php?kelas=<?= $kls ?>" target="_black"><button class="btn btn-default btn-xs"><i class="fa fa-print"></i>Cetak</button>
                                    </a>
                                <?php endif; ?>
                        </div>
                    </div>
