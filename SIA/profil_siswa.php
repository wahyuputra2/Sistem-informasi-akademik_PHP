...
INNER JOIN kelas ON siswa.kd_kelas = kelas.kd_kelas WHERE nisn = '$nisn' ")[0];
} else if ($lvl == 'siswa') {
    $students = query("SELECT * FROM siswa 
INNER JOIN kelas ON siswa.kd_kelas = kelas.kd_kelas WHERE nisn = '$masuk' ")[0];
} else if ($lvl == 'guru') {
    $nisn = $_GET["nama"];
    $students = query("SELECT * FROM siswa 
INNER JOIN kelas ON siswa.kd_kelas = kelas.kd_kelas WHERE nisn = '$nisn' ")[0];
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="img/<?= $students["gambar_siswa"]; ?>" class='rounded' width="18%" height="15%">
                        </div><br>
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Jenis Kelamin</td>
                                        <td><?= $students["jk_siswa"]; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Kelas</td>
                                        <td><?= $students["kd_kelas"]; ?></td>
                                    </tr>
                                    <tr>
                            ...
                            <a class="btn btn-info" href="nilai.php?nisn=<?= $students["nisn"]; ?>" role="button">Nilai</a>
                            <?php
                            if ($lvl == 'admin') :
                            ?>
                                <a class="btn btn-warning" href="ubah_siswa.php?nisn=<?= $students["nisn"]; ?>" role="button">Edit</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
