                    ...
                    <ul>
                        <li>
                            <div class="form-group row">
                                <label for="nisn" class="col-sm-2 col-form-label">Username</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nisn" name="username" required>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group row">
                                <label for="nama_siswa" class="col-sm-2 col-form-label">password</label>
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" id="nama_siswa" name="password" required>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group row">
                                <label for="jk_siswa" class="col-sm-2 col-form-label">Level Pengguna</label>
                                <div class="col-sm-10">
