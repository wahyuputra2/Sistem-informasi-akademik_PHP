            ...
            <div class="container-fluid">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <ul>
                        ...
                        <li>
                            <div class="form-group row">
                                <label for="umur" class="col-sm-2 col-form-label">Tempat, Tanggal Lahir</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="umur" name="ttl" require>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="radio" name="jenis_kelamin" value="perempuan"> <label>Perempuan</label>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_hp" name="no_guru" required>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="status_guru" name="status_guru" required>
                                </div>
                            </div>
                        </li>
