...
-- INNER JOIN guru_mapel ON guru.nip = guru_mapel.nip
-- INNER JOIN mapel ON guru_mapel.kd_mp = mapel.kd_mp
WHERE nip = '$nip'")[0];
}
if ($lvl == 'guru') {
    $teachers = query("SELECT * FROM guru 
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Tabel Siswa</h1>
                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="img/<?= $teachers["gambar_guru"]; ?>" class='rounded' width="18%" height="15%">
                        </div><br>
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" width="40%">NIP</th>
                                        <th scope="col"><?= $teachers["nip"]; ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Jenis Kelamin</td>
                                        <td><?= $teachers["jenis_kelamin"]; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Kelas</td>
                                        <td><?= $teachers["status_guru"]; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if ($lvl == 'admin') {
                                                $guruma = mysqli_query($conn, "SELECT * FROM jadwal 
                                                INNER JOIN mapel ON jadwal.kd_mp = mapel.kd_mp 
                                                WHERE nip = '$nip'
                                                ") or die(mysqli_error($conn));
                                                while ($gm = mysqli_fetch_array($guruma)) {
                                                    echo $gm['nama_mp'] . "<br>";
                                                }
                                            } else if ($lvl == 'guru') {
                                                $guruma = mysqli_query($conn, "SELECT * FROM jadwal 
                            ...
                            if ($lvl == 'admin') :
                            ?>
                                <a class="btn btn-info" href="ubah.php?nama=<?= $teachers["nip"]; ?>" role="button">Edit</a>
                            <?php endif; ?>
                            <br>
                            <!-- <a class="btn btn-info" href="ubah_siswa.php?nisn=<?= $student["nisn"]; ?>" role="button">Nilai</a> -->
                        </div>
                    </div>
                </div>
