...
$tambah_siswa = query("SELECT * FROM kelas");
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="radio" name="jk_siswa" value="laki-laki"> <label>Laki-Laki</label>
                                    <input type="radio" name="jk_siswa" value="perempuan"> <label>Perempuan</label>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="custom-select" id="kd_kelas" name="kd_kelas">
                                        ...
                                        <?php $i = 1; ?>
                                        <?php foreach ($tambah_siswa as $ts) : ?>
                                            <option value="<?= $ts["kd_kelas"]; ?>"><?= $ts["kd_kelas"]; ?></option>
                                            <?php $i++; ?>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                        ...
                        <li>
                            <div class="form-group row">
                                <label for="no_hp" class="col-sm-2 col-form-label">No HP (Wali)</label>
                                <div class="col-sm-10">
                        ...
                        <li>
                            <div class="form-group row">
                                <label for="no_hp" class="col-sm-2 col-form-label">Gambar</label>
                                <div class="col-sm-10">
                                    <div class="custom-file">
                                        <input name="gambar_siswa" type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
