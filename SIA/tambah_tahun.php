...
if (isset($_POST["submit"])) {
    ...
    <script> 
            ...
            document.location.href = 'tambah_tahun.php';
        </script>
        ";
    }
}
                    ...
                    <ul>
                        <li>
                            <div class="form-group row">
                                <label for="nisn" class="col-sm-2 col-form-label">Kode Tahun</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="kd_tahun" name="kd_tahun" required>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group row">
                                <label for="nisn" class="col-sm-2 col-form-label">Tahun Ajaran</label>
                                <div class="col-sm-10">
