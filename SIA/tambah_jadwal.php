    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Tambah Data Jadwal Mata Pelajaran</h1>
                <!-- DataTales Example -->
                    ...
                    <ul>
                        <li>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="kd_jadwal" name="kd_jadwal" required>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="custom-select" id="mapel" name="kd_mp">
                        ...
                        <li>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="custom-select" id="guru" name="nip">
                                ...
                                <div class="col-sm-10">
                                    <select class="custom-select" id="kd_kelas" name="kd_kelas">
                                        ...
                                        <?php foreach ($kelas as $kls) : ?>
                                            <option value="<?= $kls["kd_kelas"]; ?>"><?= $kls["kd_kelas"]; ?></option>
                                            <?php $i++; ?>
                                        <?php endforeach ?>
                                    </select>
                                </div>
