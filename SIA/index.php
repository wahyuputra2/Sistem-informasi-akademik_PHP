...
if ($lvl == 'siswa') {
    $students = query("SELECT * FROM siswa WHERE nisn = $masuk")[0];
}
                ...
                <div class="row">
                    ...
                    ?>
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <a href="jadwal_pelajaran.php?kd_kelas=<?= $students['kd_kelas']; ?>">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Jadwal Pelajaran</div>
                            ...
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="col-20">
                                            <h5><?php
                                                $students = "SELECT COUNT(*) FROM siswa";
                                                $qry_data = mysqli_query($conn, $students);
                            ...
                            <div class="col mr-2">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="col-20">
                                            <h5><?php
                                                $teachers = "SELECT COUNT(*) FROM guru";
                                                $qry_data = mysqli_query($conn, $teachers);
                                                $approve_count = mysqli_fetch_array($qry_data);
                                                $toatalCount = array_shift($approve_count);
                                                echo $toatalCount;
                                                ?></h5>
