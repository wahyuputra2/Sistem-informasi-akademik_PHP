            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tambah_is.php">Tambah Data Siswa</a>
                        <a class="collapse-item" href="tambah_guru.php">Tambah Guru</a>
                        <a class="collapse-item" href="tambah_is.php">Tambah Mata Pelajaran</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <div class="card bg-light text-white shadow">
                                <div class="card-body"> <a href="jadwal_pelajaran.php" class="text-dark">
                                        Kelas 1 </a>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card bg-light text-white shadow">
                                <div class="card-body">
                                    <a href="jadwal_pelajaran.php" class=" text-dark">Kelas 6</a>
                                    <div class="text-white-50 small">-----</div>
                                </div>
                            </div>
                        </div>
